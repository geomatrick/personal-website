...
description: "A comprehensive summary of the Retrieval Markets Working Group progress throughout the first half of 2022."
---

# Retrieval Markets Rollup H1 2022

Published: 2022/07/18
Published At: https://filecoin.io/blog/posts/retrieval-markets-rollup-h1-2022/
Subtitle: A summary of progress in the first half of 2022
Topics: Blockchain, Engineering

## **TL;DR**

The Retrieval Markets Working Group (RMWG) has been hard at work in 2022! This report gives a summary of its progress in the first half of 2022, and some insights into what to expect in H2 2022.
...
![Untitled](Retrieval%20Markets%20Rollup%20H1%202022/Untitled.png)
...
![Untitled](Retrieval%20Markets%20Rollup%20H1%202022/Untitled%201.png)
...
[Myel](https://myel.network) has envisioned a retrieval network based on the assumption that the Retrieval Client will always pay directly for the retrieval. 

![Untitled](Retrieval%20Markets%20Rollup%20H1%202022/Untitled%202.png)
...
![Untitled](Retrieval%20Markets%20Rollup%20H1%202022/Untitled%203.png)
...
![Untitled](Retrieval%20Markets%20Rollup%20H1%202022/Untitled%204.png)
...
![Untitled](Retrieval%20Markets%20Rollup%20H1%202022/Untitled%205.png)
...
In April 2022, [Ken Labs](https://kencloud.com/) completed a grant to build [Pando](https://github.com/kenlabs/pando), an off-chain verifiable data store for network data and metadata. 
...
From the RMWG, both [Leeway Hertz](https://www.leewayhertz.com/) and [Ken Labs](https://kencloud.com) are running an Indexer node and are exploring what else they could build around the indexer relating to tooling and testing.
...
Leeway Hertz has also built a [dashboard for Saturn](http://ec2-18-234-126-134.compute-1.amazonaws.com:3005/d/c7UEvVjnk/saturn-performance-dashboard?orgId=1), to help the team monitor the performance of the network. The team is now also looking into building a dashboard to show retrieval performance from SPs.

## Dive in to the RMWG

There are a few places you can find lots more information on the work of the RMWG.

Between February and April 2022, [Onda Studio](https://www.ondastudio.co/) worked on a new website for the RMWG [https://retrieval.market](https://retrieval.market). On this page, you can find links to all the teams, projects and available opportunities. 

Another great place to find information is the [Retrieval Markets Notion folder](https://www.notion.so/765a9388b86646f38f7a03ee90c9c6c4?pvs=21) that we’ve updated on a weekly basis since the beginning of 2022.
