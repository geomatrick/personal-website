---
title: "Survivorship Bias in Startups"
date: "2018-03-26"
categories: ["Startups"]
description: "How survivorship bias affects product development and what startups can do about it."
---

# Survivorship Bias in Startups

Published: 2018/03/26
Published At: https://medium.com/hackernoon/survivorship-bias-in-startups-835128b18816
Subtitle: An amazing story from World War 2 provides a lesson in user acquisition for startups.
Topics: Startups

![Photo by [Lacie Slezak](https://unsplash.com/photos/7ZaFhK3LNVE?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/search/photos/airplane?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)](https://miro.medium.com/max/700/1*NwXJMmiIDVtgC_VcSP3Q9Q.jpeg)
...
When I read this story, it immediately made me rethink our user acquisition approach at [Pilcro](https://www.pilcro.com/?utm_source=medium&utm_medium=survivorship&utm_campaign=awareness).

# **Survivorship bias in startups**

*The following example relates to my experience at Pilcro, a software [startup](https://hackernoon.com/tagged/startup), but it can be applied more generally.*

Imagine each potential user in your target market is a plane.

Then every sticking point, bad advert, [miscommunication](https://hackernoon.com/tagged/miscommunication), missed conversion, bad meeting, missed opportunity in your marketing and sales funnel, confusing moment in your user onboarding, is an enemy bullet.
...
![Journey of a potential user from nothing to top user](https://miro.medium.com/max/700/1*FRsoSQ1Gs3hpdvRfKF8DkA.png)

Journey of a potential user from nothing to top user

# **We had exactly this realisation**
